...
const language = "${icons}heroiconss_language.svg";
...
const iconInvoice = "${icons}invoice_outlined.svg";
const iconInvoiceFilled = "${icons}invoice_filled.svg";
const iconReport = "${icons}report_outlined.svg";
const iconReportFilled = "${icons}report_filled.svg";
...
const emailRex = "^[a-zA-Z0-9.a-zA-Z0-9.!#%&'*+-/=?^_`{|}~]+@[a-zA-Z0-9]+\.[a-zA-Z]+";
